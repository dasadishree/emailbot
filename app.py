            ...
            response = requests.post(
                ...
                json={
                    ...
                    "messages": [
                        ...
                        {
                            "role": "user",
                            "content": f"""List professors at {school} who work in {category}.
                    ...
                    - Interpret typos in the research areas generously (e.g. "neurosicence" means neuroscience)
...
def search():
    ...
    try:
        ...
        return jsonify({
            "error": "Could not read professor results. Try again — typos in research areas are fine, but the AI response was malformed."
        }), 502
    ...
    return jsonify({"professors": ranked, "school": school, "category": category})
